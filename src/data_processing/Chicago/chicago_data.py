...
# 5 - religion
# 6 - restaurant
init_cases = np.array([107,2,26,1,7,3,1,2,1,4,1,1,1])
...
fitness = pd.read_excel(os.path.join(data_path, 'Intercity_Chicago_Fitness.xlsx'))
grocery = pd.read_excel(os.path.join(data_path, 'Intercity_Chicago_Grocery.xlsx'))
hotel = pd.read_excel(os.path.join(data_path, 'Intercity_Chicago_HotelMotel.xlsx'))
pharmacy = pd.read_excel(os.path.join(data_path, 'Intercity_Chicago_Pharmacy.xlsx'))
physician = pd.read_excel(os.path.join(data_path, 'Intercity_Chicago_Physician.xlsx'))
religion = pd.read_excel(os.path.join(data_path, 'Intercity_Chicago_Religious.xlsx'))
restaurant = pd.read_excel(os.path.join(data_path, 'Intercity_Chicago_Restaurant.xlsx'))
...
#fitness_data = pd.read_excel(os.path.join(data_path, 'Intercity_Chicago_Fitness.xlsx'))
...
device_data = pd.read_excel(os.path.join(data_path, 'Chicago_Device_bg.xlsx'))
...
population_data = pd.read_excel(os.path.join(data_path, 'Chicago_Population_bg.xlsx'))
for index, row in population_data.iterrows():
    if row['Geographic Area Name'] in counties:
        ind = counties.index(row['Geographic Area Name'])
        populations[ind] = populations[ind] + row['TotalPop']
...
grocery_data = pd.read_excel(os.path.join(data_path, 'Intercity_Chicago_Grocery.xlsx'))
...
pharmacy_data = pd.read_excel(os.path.join(data_path, 'Intercity_Chicago_Pharmacy.xlsx'))
...
physician_data = pd.read_excel(os.path.join(data_path, 'Intercity_Chicago_Physician.xlsx'))
...
hotel_data = pd.read_excel(os.path.join(data_path, 'Intercity_Chicago_HotelMotel.xlsx'))
...
# religion_data = pd.read_excel(os.path.join(data_path, 'Intercity_Chicago_Religious.xlsx'))
...
restaurant_data = pd.read_excel(os.path.join(data_path, 'Intercity_Chicago_Restaurant.xlsx'))
...
np.save(os.path.join(data_path, 'data_processing_outputs', 'demand_array_chicago.npy'), demand_array)
np.save(os.path.join(data_path, 'data_processing_outputs', 'populations_array_chicago.npy'), populations)
